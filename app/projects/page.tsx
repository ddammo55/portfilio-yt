...
export default async function Projects() {
    ...
    return (
        <div className='divide-y divide-gray-200 dark:divide-gray-700'>
            ...
            <div className='grid gap-4 sm:grid-col-2 md:gap-6 lg:grid-cols-3 lg:gap-10 pt-8'>
                {data.map((project) => (
                    <article key={project._id} className='overflow-hidden dark:border-zinc-600 rounded-lg border border-gray-100 bg-white shadow-lg dark:bg-black dark:shadow-gray-700 shadow-teal-100'>
                       ...
                       <div className='p-4 sm:p-6'>
                        ...
                        <a href={project.link} target='_blank' className='group mt-4 inline-flex items-center gap-1 text-sm  font-medium text-teal-500'>Learn More
